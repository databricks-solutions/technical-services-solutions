...
from migration_accelerator.app.api.routes import analyzer, lineage, upload
...
app = FastAPI(
    ...
    description=(
        "API for migration assessment and lineage visualization. "
        "All SQL data warehouse platforms are supported; for ETL tools, only Informatica "
        "(Lakebridge analyzer exports) is supported."
    ),
