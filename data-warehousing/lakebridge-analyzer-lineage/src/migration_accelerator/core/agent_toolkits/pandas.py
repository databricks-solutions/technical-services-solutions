...
from migration_accelerator.core.agent_toolkits.tools import PythonAstREPLTool
...
def create_pandas_dataframe_agent(
    ...
    df: Any,
    agent_type: Literal[
        "zero-shot-react-description", "openai-functions", "openai-tools", "tool-calling"
    ...
    **kwargs: Any,
    ...
    elif agent_type in ("openai-functions", "openai-tools", "tool-calling"):
