...
*Important*: The difference between this deployment option and the standard option for azure-vnet-injection is the inclusion of a default catalog and external location. The requirements and authentication procedures remain the same.
...
- uc_storage_name
    - The name of the storage account for the catalog in UC
